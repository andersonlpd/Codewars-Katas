The maximum sum subarray problem consists in finding the maximum sum of a contiguous (should be 'continuous') subsequence in an array or list of integers:<br>
<br>
## Examples: 
